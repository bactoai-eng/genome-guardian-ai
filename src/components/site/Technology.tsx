export function Technology() {
  const stack = ["Python", "Machine Learning", "Bioinformatics", "Cloud Computing", "Genomics", "Artificial Intelligence"];
  const flow = ["Genome Sequence", "Feature Extraction", "ML Models", "Resistance Prediction", "Clinical Report"];
  return (
    <section id="technology" className="py-24 md:py-32 bg-card/40">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <div className="text-sm font-semibold text-primary uppercase tracking-widest">Technology</div>
            ...
            {flow.map((f, i) => (
              <div key={f} className="relative">
                <div className="rounded-2xl bg-gradient-hero text-white p-5 h-full text-center shadow-soft">
                  <div className="text-[10px] uppercase tracking-widest opacity-80">Stage {i + 1}</div>
